...
/*
Emergency cess
Due to a natural disaster, the government is exploring various ways to gather relief fund. 
One proposal is to collect a one time cess from salaried employees. 
As per the proposal, everyone should pay ceil(7% of their monthly salary).
Given a the number of employees and their monthly salaries, help the government 
find the fund that can be gathered in a month.
Write a function to do this calculation.

Input
First line contains an integer n, denoting the number of employees. 
Next line contains n space seperated integers, denoting the monthly salaries of the n employees.
...
function calculateTotalFund(salaries, peopleCount){
    ...
    totalFund=Math.ceil(totalFund+ (salaries[i]*7/100));
    }return (totalFund);
