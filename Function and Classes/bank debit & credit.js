...
Write a bank account class (BankAccount). It should have an instance variable called balance 
which holds the current value. Assume initial balance is 0. 
...
function BankAccount(){
    this. balance = 0
    this.debit = function(transactionAmount){
        this.balance = this.balance - transactionAmount

    }
    this.credit =function(transactionAmount){
        this.balance = this.balance + transactionAmount;
